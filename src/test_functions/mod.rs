...
pub fn hosaki(x: &Vec<f64>) -> f64 {
  ...
  let x1 = x[0];
  let x2 = x[1];
  (1_f64 - 8_f64 * x1 + 7_f64 * f64::powi(x1, 2) - 7_f64 / 3_f64 * f64::powi(x1, 3) + 0.25 * f64::powi(x1, 4))
    * f64::powi(x2, 2)
    ...
    * f64::exp(f64::powi(
      f64::abs(
        f64::cos(x1)
          ...
          * f64::powf(
            f64::consts::E,
            f64::abs(1_f64 - f64::powf(f64::powi(x1, 2) + f64::powi(x2, 2), 0.5 / f64::consts::PI)),
          ),
      ),
      -1,
    ))
      ...
      + i as f64
        * f64::log(
          1_f64
            + i as f64
              * f64::powi(
                f64::powi(x[i - 1], 2) - 2_f64 * val - 3_f64 * x[i - 1] - f64::cos(*val) + 1_f64,
                2,
              ),
          10_f64,
        )
