...
pub fn sphere(params:&Vec<f64>) -> f64{
    let mut res = 0 as f64;
    for param in params.iter(){
...
pub fn rosenbrock(params:&Vec<f64>) -> f64{
    let mut res = 0 as f64;
...
pub fn beale(params:&Vec<f64>) -> f64{
...
pub fn goldsteinprice(params:&Vec<f64>) -> f64{
    let x1 = params[0];
    let x2 = params[1];
...
//Booth
//TODO DWUWYMIAROWA
pub fn booth(params:&Vec<f64>) -> f64{
...
//Bukin n. 6
//TODO DWUWYMIAROWA
pub fn bukin6(params:&Vec<f64>) -> f64{
...
//Matyas
//TODO DWUWYMIAROWA
pub fn matyas(params:&Vec<f64>) -> f64{
...
//Levi n. 13
//TODO DWUWYMIAROWA
pub fn levi13(params:&Vec<f64>) -> f64{
...
pub fn himmelblau(params:&Vec<f64>) -> f64{
...
//Three-hump camel
//TODO DWUWYMIAROWA
pub fn threehumpcamel(params:&Vec<f64>) -> f64{
...
//Easom
//TODO DWUWYMIAROWA
pub fn easom(params:&Vec<f64>) -> f64{
...
//Cross-in-tray
//TODO DWUWYMIAROWA
pub fn crossintray(params:&Vec<f64>) -> f64{
...
//Eggholder
//TODO DWUWYMIAROWA
pub fn eggholder(params:&Vec<f64>) -> f64{
...
//Holder table
//TODO DWUWYMIAROWA
pub fn holdertable(params:&Vec<f64>) -> f64{
...
//McCormick
//TODO DWUWYMIAROWA
pub fn mcormick(params:&Vec<f64>) -> f64{
...
//Schaffer N.2
//TODO DWUWYMIAROWA
pub fn schaffer2(params:&Vec<f64>) -> f64{
...
//Schaffer N.4
//TODO DWUWYMIAROWA
pub fn schaffer4(params:&Vec<f64>) -> f64{
...
pub fn styblinskitang(params:&Vec<f64>) -> f64{
    let mut res = 0 as f64;
    for param in params.iter(){
